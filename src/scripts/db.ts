...
async function saveGameThreads(gameThreads, matchRepository, threadRepository) {
  await forEachSeries(gameThreads, async(game) => {
      ...
      if (gameThreadToUpdate) {
        ...
        gameThreadToUpdate.down = game.gameThread.downs;
        gameThreadToUpdate.ups = game.gameThread.ups;
        ...
        gameThreadToUpdate.score = game.gameThread.score;
        gameThreadToUpdate.numComments = game.gameThread.num_comments;
        ...
        gameThread.down = game.gameThread.downs;
        gameThread.ups = game.gameThread.ups;
        gameThread.matchId = game.match.id;
        gameThread.url = game.gameThread.url;
        gameThread.title = game.gameThread.title;
        gameThread.score = game.gameThread.score;
        gameThread.numComments = game.gameThread.num_comments;
...
async function savePostGameThreadOrUpdate(targetThread, fullCommentsFromReddit, topComments, id, matchId, postGameThreadRepository, matchRepository) {
  ...
  if (postGameThread) {
    ...
    postGameThread.down = targetThread.downs;
    postGameThread.ups = targetThread.ups;
    postGameThread.matchId = matchId;
    postGameThread.url = targetThread.url;
    postGameThread.title = targetThread.title;
    postGameThread.score = targetThread.score;
    postGameThread.numComments = targetThread.num_comments;
    ...
    threadToSave.down = targetThread.downs;
    threadToSave.ups = targetThread.ups;
    threadToSave.matchId = matchId;
    threadToSave.url = targetThread.url;
    threadToSave.title = targetThread.title;
    threadToSave.score = targetThread.score;
    threadToSave.numComments = targetThread.num_comments;
